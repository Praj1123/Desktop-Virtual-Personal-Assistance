        ...
        if 'wake up luna' in query: 
            ...
            while True:
                ...
                if 'sleep luna' in query:
                    ...
                    speak('Ok prajwal,When ever you need my help,just call me out,have a nice day,Buy')
                    exit()
                    ...
                    speak('ok, what would you like to here, top headlines of india or world')
                    input = input('Type india or world:')
                    from news import news
                    news(input)
                
                elif 'calculate' in query:
                    query = query.replace('calculate','').replace('luna','')
